...
const Hero = () => {
  ...
  // Use API image if available, otherwise use kundalgaon image
  const heroImage = heroImageUrl ? getImageUrl(heroImageUrl) : kundalgaonImage;
    ...
    <section id="home" className="relative h-[500px] md:h-[600px] overflow-hidden">
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-white z-10">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-8 drop-shadow-2xl animate-fade-in text-white">
